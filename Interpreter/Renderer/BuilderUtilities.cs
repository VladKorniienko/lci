namespace LCI_Korniienko.Renderer
{
    class BuilderUtilities
    {
        ...
        internal BuilderUtilities(char[,] plane)
        {
            this.plane = plane;
            this.plane = FillBlanks(this.plane, ' ');
        }

        internal BuilderUtilities(int width, int height)
        {
            this.plane = new char[width, height];
            this.plane = FillBlanks(this.plane, ' ');
        }

        internal BuilderUtilities (int width, int height, BuilderUtilities subplane, PlaneAlignment alignment) : this(width, height)
        {
        ...
        internal BuilderUtilities(int width, int height, BuilderUtilities subplane) : this(width, height, subplane, PlaneAlignment.TOP_LEFT) {}
        ...
        internal void Embedd(BuilderUtilities subplane, PlaneAlignment alignment)
        {
