...
namespace LCI_Korniienko.Components
{
    class Application : Expression
    {
        ...
        public override Expression Reduce(Evaluation eval, bool annotate)
        {
        ...
        public override Expression ExpandVariable(bool annotate)
        {
            ...
            if (!this.expr1.Equals(firstExpanded) && !this.expr2.Equals(secondExpanded))
            {
                var e = new Application(firstExpanded, secondExpanded);
                lastOperation = Operation.Expand;
                Log(e.ToString(), annotate);
                return e;
            }
            else if (!this.expr1.Equals(firstExpanded))
            {
